...
**PONERLO EN VERDE**In this second edition, we include **new tasks that allow participants to train their models unconstrained by the number of synthetic images.**
