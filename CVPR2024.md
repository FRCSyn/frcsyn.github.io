...
3. **Combining real and synthetic data constrained to:** 1) **maximum 500,000 synthetic face images (e.g., 10,000 identities and 50 images per identity).** Synthetic face images can be generated using any state-of-the-art methods, **no restrictions**. We provide some suggestions in the following section; and 2) **only the proposed CASIA-WebFace dataset (around 500,000 real face images)**, provided to the participants after registration.
...
**The platform used in the 2nd edition of FRCSyn Challenge is [CodaLab](link/codaklab). Participants need to register to take part in the challenge. <strong style="color:green">Rules and important information are in the CodaLab**</strong>. Please, follow the instructions:
