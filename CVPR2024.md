...
3. **Combining real and synthetic data** constrained to maximum **500,000 face images** (e.g., 10,000 identities and 50 images per identity). Synthetic face images can be generated using any state-of-the-art methods, no restrictions. We provide some suggestions in the following section.
...
**The platform used in the 2nd edition of FRCSyn Challenge is [CodaLab](link/codaklab). Participants need to register to take part in the challenge. Rules and important information are in the CodaLab**. Please, follow the instructions:
...
<table>
  <tr>
    ...
    <td width="33%">
      <div>
        <p align="center"><img src="/assets/images/Ivan" style="width:70%;height:auto;"></p>
        <p align="center"><a href="https://mckim.dev/">Ivan de Andres</a></p>
        <p align="center">Universidad Autonoma de Madrid, Spain</p>
      </div>
    </td>
  </tr>
